...
if (!$guestHasPermission) {
    if (empty(auth()->user())) {
        ...
        if (!Gate::allows('browse bread ' . $table)) {
            abort(401);
        }
    }
}
    ...
    public function create($table, Request $request)
    {
        ...
        if(!$guestHasPermission){
            if(empty(Auth::user())){
                ...
                if(!Gate::allows('add bread ' . $table)){
                    abort('401');
                }
            }
        }
    ...
    public function show($table, $id, Request $request)
    {
        ...
        if(!$guestHasPermission){
            if(empty(Auth::user())){
                ...
                if(!Gate::allows('read bread ' . $table)){
                    abort('401');
                }
            }
        }
    ...
    public function edit($table, $id)
    {
        ...
        if(!$guestHasPermission){
            if(empty(Auth::user())){
                ...
                if(!Gate::allows('edit bread ' . $table)){
                    abort('401');
                }
            }
        }
    ...
    public function destroy($table, Request $request, $id)
    {
        ...
        if(!$guestHasPermission){
            if(empty(Auth::user())){
                ...
                if(!Gate::allows('delete bread ' . $table)){
                    abort('401');
                }
            }
        }
